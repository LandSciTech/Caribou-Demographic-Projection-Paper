...
Discuss limitations of assumption that example populations remain in their quantile over time which limits ranges from transitioning e.g. really low values to really high values. If you think of the larger variation at low disturbance values = variation created by climatic events or some other short term factor influence habitat this could be problematic. not sure if being clear but trying to say that ranges with poor demography at low disturbance values could experience high demographic values a few years later (as observed in NWT)

Discuss what is gained by including misidentification bias parameters.

Discuss pros and cons of alternative approach to modelling with more age classes...
...
which is more variable among study areas and with anthropogenic disturbance,
...
the study area, and on spatial variation in calf mortality risk that is not
measured directly.
