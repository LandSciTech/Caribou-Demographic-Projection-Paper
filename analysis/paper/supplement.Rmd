...
The choice of priors for the random effects of year on survival and recruitment are less important because the random effects have no effect on expected population growth rate (Figs \@ref(fig:PriorAllFits) and \@ref(fig:PriorAllFitsR)). We set the hyperprior for the standard deviation of the survival random effect to vary uniformly between sSigmaMin = 0.00001 and sSigmaMax = 0.06 to exceed the variation among national model simulations by a moderate amount (Fig \@ref(fig:PriorAllFits)). We set the hyperprior for the standard deviation of the recruitment random effect to vary uniformly between rSigmaMin = 0.00001 and rSigmaMax = 0.2 to exceed the variation among national model simulations by a moderate amount (Fig \@ref(fig:PriorAllFitsR)).
...
if(doPriorCalibration){
  source(here::here("analysis/scripts/PriorsFromPIs.R"))
